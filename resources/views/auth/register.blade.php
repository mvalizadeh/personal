                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-7 col-md-6">
                            <div class="mr-lg-5">   
                                <img src="{{ asset('app/images/user/signup.svg') }}" class="img-fluid d-block mx-auto" alt="">
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group position-relative">                                                
                                                    ...
                                                    <input type="text" class="form-control pl-5" placeholder="نام " name="name" >
                                                </div>
                                                @error('name')
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group position-relative">
                                                    ...
                                                    <input type="email" class="form-control pl-5" placeholder="ایمیل" name="email">
                                                </div>
                                                @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group position-relative">
                                                    ...
                                                    <input type="password" class="form-control pl-5" placeholder="رمز عبور" name="password">
                                                </div>
                                                @error('password')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                                <div class="form-group position-relative">
                                                    ...
                                                    <i data-feather="key" class="fea icon-sm icons"></i>
                                                    <input type="password" class="form-control pl-5" placeholder="تکرار رمز عبور" name="password_confirmation">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
